...
/* EXPECTED:CALL_SITES{
  ...
  "callables": [
    {
      "name": "/fnptr_fold/fn1(u32,&'^0.Named(DefId(0:7 ~ fnptr_fold[1b64]::fn1::'_), \"'_\") Binder { value: fn(u32) -> u32, bound_vars: [] })->u32",
      "file_index": 0,
      "first_line": 10,
      "local": true
    },
    ...
    {
      "name": "/std/std::io::_print(std::fmt::Arguments<'^0.Named(DefId(1:14015 ~ std[8790]::io::stdio::_print::'_), \"'_\")>)->()",
      "file_index": 1,
      "first_line": 1232,
      "local": false
    },
