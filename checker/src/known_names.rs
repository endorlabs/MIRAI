...
fn known_name_for_mirai_annotations(
    ...
    match path_segments {
        [current_segment] => match current_segment.data {
            // Handles functions.
            ...
            // Handles macros.
            DefPathData::MacroNs(name) => match_names!(
                name.as_str(),
                "abstract_value" => KnownNames::MiraiAbstractValue,
                "add_tag" => KnownNames::MiraiAddTag,
                "assume" => KnownNames::MiraiAssume,
                "assume_preconditions" => KnownNames::MiraiAssumePreconditions,
                "does_not_have_tag" => KnownNames::MiraiDoesNotHaveTag,
                "get_model_field" => KnownNames::MiraiGetModelField,
                "has_tag" => KnownNames::MiraiHasTag,
                "postcondition" => KnownNames::MiraiPostcondition,
                "precondition_start" => KnownNames::MiraiPreconditionStart,
                "precondition" => KnownNames::MiraiPrecondition,
                "result" => KnownNames::MiraiResult,
                "set_model_field" => KnownNames::MiraiSetModelField,
                "verify" => KnownNames::MiraiVerify,
            ),
            _ => None,
        },
        _ => None,
